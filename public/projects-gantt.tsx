...
export function ProjectsGanttPanel({ filterOrcid }: { filterOrcid?: string | null }) {
  ...
  if (err) return <section className="card card-span-2"><SectionHead eyebrow="Proyectos" title="Carta Gantt" /><div className="muted">Error: {err}</div></section>;
  if (!projects) return <section className="card card-span-2"><SectionHead eyebrow="Proyectos" title="Carta Gantt" /><div className="muted skel" style={{ height: 200 }} /></section>;
  if (!filtered.length) return <section className="card card-span-2"><SectionHead eyebrow="Proyectos" title="Carta Gantt" /><div className="muted">Sin proyectos con fechas registradas.</div></section>;
  ...
  return (
    <section className="card card-span-2 gantt-card">
      <SectionHead
        eyebrow="Proyectos"
        title="Carta Gantt"
