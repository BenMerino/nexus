...
export function ProjectsGanttPanel({ filterOrcid }: { filterOrcid?: string | null }) {
  ...
  if (err) return <section className="card card-span-4"><SectionHead eyebrow="Proyectos" title="" /><div className="muted">Error: {err}</div></section>;
  if (!projects) return <section className="card card-span-4"><SectionHead eyebrow="Proyectos" title="" /><div className="muted skel" style={{ height: 200 }} /></section>;
  if (!filtered.length) return <section className="card card-span-4"><SectionHead eyebrow="Proyectos" title="" /><div className="muted">Sin proyectos con fechas registradas.</div></section>;
