...
function classifyNodes(nodes, edges, allNodes, communityMap) {
  ...
  for (const e of edges) {
    ...
    const sMap = profileMap.get(e.source) || /* @__PURE__ */ new Map();
    sMap.set(tNode.group, (sMap.get(tNode.group) || 0) + e.weight);
    profileMap.set(e.source, sMap);
    const tMap = profileMap.get(e.target) || /* @__PURE__ */ new Map();
    tMap.set(sNode.group, (tMap.get(sNode.group) || 0) + e.weight);
    profileMap.set(e.target, tMap);
  }
  const degrees = nodes.map((n) => n.degree).sort((a2, b) => a2 - b);
  const weights = nodes.map((n) => n.weight).sort((a2, b) => a2 - b);
  const degP75 = percentile(degrees, 0.75);
  const degMedian = percentile(degrees, 0.5);
  const weightP75 = percentile(weights, 0.75);
  const avgWeights = nodes.filter((n) => n.degree > 0).map((n) => n.weight / n.degree).sort((a2, b) => a2 - b);
...
function projectGraph(rawNodes, rawEdges, activeCategories, pinnedTags, expandedJournal) {
  ...
  const journalPapers = /* @__PURE__ */ new Map();
  ...
  function addNode(id, label, group, w, papers, ext_id) {
    if (added.has(id)) return;
    added.add(id);
    allNodes.push({ id, label, group, ext_id, doiCount: w, degree: 0, weight: w || 1, papers });
  }
  for (const inst of institutions) addNode(inst.id, inst.label, "institution", 0, void 0, inst.id.replace(/^[^:]+:/, ""));
  for (const auth of authors) {
    addNode(auth.id, auth.label, "author", 0, void 0, auth.id.replace(/^[^:]+:/, ""));
...
function useForceLayout(inputNodes, edges, width, height) {
  ...
  const pinTimer = (0, import_react.useRef)(null);
  ...
  (0, import_react.useEffect)(() => {
    ...
    const rowH = 90;
    const gridTop = 130;
    journals.sort((a2, b) => (b.weight || 0) - (a2.weight || 0));
    ...
    const alwaysPin = /* @__PURE__ */ new Set(["institution", "author"]);
    ...
    const links = edges.filter((e) => nodeIndex.has(e.source) && nodeIndex.has(e.target)).map((e) => ({ source: nodeIndex.get(e.source), target: nodeIndex.get(e.target) }));
    const flush = () => {
      if (dirtyRef.current) {
    ...
    rafRef.current = requestAnimationFrame(flush);
    const sim = simulation_default(nodes).force("link", link_default(links).distance(50).strength(0.03)).force("x", x_default2((n) => pos.get(n.id)?.x ?? width / 2).strength((n) => n.group === "doi" ? 0.4 : 0.9)).force("y", y_default2((n) => pos.get(n.id)?.y ?? height / 2).strength((n) => n.group === "doi" ? 0.4 : 0.9)).force("collide", collide_default().radius((n) => nodeRadius(n.weight || 0) + 12).strength(0.5).iterations(2)).alphaDecay(0.08).velocityDecay(0.6).on("tick", () => {
...
function useFilterState() {
  const [categoryOrder, setCategoryOrder] = (0, import_react2.useState)([...TAG_CATEGORIES]);
  const [activeCategories, setActiveCategories] = (0, import_react2.useState)(() => new Set(TAG_CATEGORIES));
  const [pinnedTags, setPinnedTags] = (0, import_react2.useState)([]);
  const [filtersVisible, setFiltersVisible] = (0, import_react2.useState)(false);
  const toggleCategory = (0, import_react2.useCallback)((cat) => {
  ...
  const toggleTag = (0, import_react2.useCallback)((id) => {
    setPinnedTags((prev) => prev.includes(id) ? prev.filter((t) => t !== id) : [...prev, id]);
  }, []);
  const reorderCategories = (0, import_react2.useCallback)((from, to) => {
...
function CategoryStrip({ categories, counts, active, onToggle, onReorder }) {
  ...
  const onDragStart = (0, import_react3.useCallback)((e, idx) => {
    dragRef.current = idx;
    setDragIdx(idx);
    e.dataTransfer.effectAllowed = "move";
  }, []);
  const onDragOver = (0, import_react3.useCallback)((e, idx) => {
    e.preventDefault();
    e.dataTransfer.dropEffect = "move";
    setOverIdx(idx);
  }, []);
  const onDrop = (0, import_react3.useCallback)((e, toIdx) => {
    e.preventDefault();
  ...
  const onDragEnd = (0, import_react3.useCallback)(() => {
    setDragIdx(null);
    setOverIdx(null);
    dragRef.current = null;
  }, []);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, color: "#999", fontFamily: "monospace", marginRight: 2 }, children: "layout order" }),
    visible.map((cat, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { color: isActive ? COLORS[cat] : "#ccc", fontSize: 10, letterSpacing: 1, lineHeight: 1 }, children: "\u283F" }),
            orderNum !== null && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: {
              display: "inline-flex",
              alignItems: "center",
            ...
            cat,
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { style: { fontSize: 10, opacity: 0.7 }, children: [
              "(",
              counts[cat] || 0,
              ")"
            ] })
...
function TagPicker({ category, tags, pinnedTags, pinnedOrder, onToggleTag }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { marginBottom: 6 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: COLORS[category] }, children: category }),
      hasPins && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          onClick: () => {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: 3 }, children: [
      visible.map((t) => {
        ...
        return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            children: [
              t.label,
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { style: { fontSize: 9, opacity: 0.6 }, children: t.doiCount })
            ]
          },
          t.id
        );
      }),
      tags.length > 12 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
...
function DetailPanel({
  ...
  const allDois = (0, import_react4.useMemo)(() => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 11, color: "#999", marginTop: 4, display: "flex", gap: 8, flexWrap: "wrap" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
            "weight: ",
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("strong", { style: { color: COLORS[node.group] }, children: node.weight })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
            node.degree,
            " connection",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: onClose, style: { background: "none", border: "none", cursor: "pointer", fontSize: 16, color: "#999", padding: "0 4px", lineHeight: 1 }, children: "x" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: "#666", marginBottom: 8, borderBottom: "1px solid #eee", paddingBottom: 4 }, children: [
      "Connected tags (",
      connections.length,
      ")"
    ] }),
    Object.entries(grouped).sort(([a2], [b]) => a2.localeCompare(b)).map(([group, items]) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { marginBottom: 10 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 10, textTransform: "uppercase", letterSpacing: 0.5, fontWeight: 700, color: COLORS[group], marginBottom: 3 }, children: [
        group,
        " (",
        items.length,
        ")"
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { display: "flex", flexWrap: "wrap", gap: 4 }, children: [
        items.slice(0, 25).map(({ node: item, weight }) => /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
          "span",
          {
            ...
            children: [
              item.label,
              weight > 1 && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontSize: 9, opacity: 0.7, fontWeight: 700 }, children: weight })
            ]
          },
          item.id
        )),
        items.length > 25 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { style: { fontSize: 11, color: "#999" }, children: [
          "+",
          items.length - 25,
          " more"
        ] })
    ...
    allDois.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { marginTop: 12, borderTop: "1px solid #eee", paddingTop: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: "#666", marginBottom: 6 }, children: [
        "Papers (",
        allDois.length,
        ")"
      ] }),
      allDois.slice(0, 15).map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { style: { fontSize: 11, color: "#555", padding: "2px 0", borderBottom: "1px solid #f5f5f5", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: d }, i)),
      allDois.length > 15 && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { fontSize: 11, color: "#999", marginTop: 4 }, children: [
        "+",
        allDois.length - 15,
        " more"
      ] })
...
function monotoneSlopes(pts) {
  ...
  m2.push(d[0]);
  for (let i = 1; i < n - 1; i++) m2.push(d[i - 1] * d[i] <= 0 ? 0 : (d[i - 1] + d[i]) / 2);
  m2.push(d[n - 2]);
  for (let i = 0; i < n - 1; i++) {
    if (d[i] === 0) {
      m2[i] = 0;
    ...
    const a2 = m2[i] / d[i], b = m2[i + 1] / d[i];
    const s = a2 * a2 + b * b;
    if (s > 9) {
...
var BaseBox = import_react5.default.forwardRef(
  ({ children, direction, gap, px, py, surfaceRadius, shadow, style, ...rest }, ref) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { ref, style: s, ...rest, children });
  }
);
...
function BaseText({ children, variant, weight, color, style, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("span", { style: s, ...rest, children });
}
...
function seriesColor(scheme2, i) {
  return scheme2.seriesColors?.[i % (scheme2.seriesColors?.length || 1)] ?? FALLBACK_SERIES[i % FALLBACK_SERIES.length];
}
...
function XAxisBand({ labels, y: y2, range }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: labels.map((l, i) => {
    const cx = range[0] + i * step + step / 2;
    const display = l.length > maxChars ? l.slice(0, maxChars - 1) + "\u2026" : l;
    return rotate ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: y2 + 6, textAnchor: "end", transform: `rotate(-40,${cx},${y2 + 6})`, ...TICK, children: display }, i) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: y2 + 14, textAnchor: "middle", ...TICK, children: display }, i);
  }) });
}
function XAxisLinear({ domain, y: y2, range }) {
  const s = linearScale([domain.min, domain.max], range);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ticks(domain).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: s(v), y: y2 + 14, textAnchor: "middle", ...TICK, children: v }, i)) });
}
function YAxis({ domain, range, x: x2 }) {
  const s = linearScale([domain.min, domain.max], range);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ticks(domain).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: x2 - 4, y: s(v) + 3, textAnchor: "end", ...TICK, children: fmtTick(v) }, i)) });
}
function fmtTick(v) {
...
function fmtValue(v, c2) {
  const s = v.toLocaleString(void 0, { maximumFractionDigits: 0 });
  if (!c2) return s;
  const sym = c2.currency || "$";
  return c2.currencyFormat === "suffix" ? `${s} ${sym}` : `${sym}${s}`;
}
function GridLines({ domain, range, xRange }) {
  const s = linearScale([domain.min, domain.max], range);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ticks(domain).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: xRange[0], x2: xRange[1], y1: s(v), y2: s(v), stroke: GRID_STROKE, strokeOpacity: 0.08 }, i)) });
}
function ThresholdLines({ thresholds, yScale, xRange }) {
  if (!thresholds?.length) return null;
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: thresholds.map((t, i) => {
    const y2 = yScale(t.value);
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: xRange[0], x2: xRange[1], y1: y2, y2, stroke: t.color, strokeDasharray: "4 4", strokeWidth: 1 }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: xRange[1] - 2, y: y2 - 4, textAnchor: "end", fontSize: 9, fontWeight: 600, fill: t.color, children: t.label })
    ] }, i);
  }) });
}
function useTooltip() {
...
function Crosshairs({ tip, xR, yR, mode, ms = 0 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { opacity: 0.4, pointerEvents: "none", children: [
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: tip.vbX, x2: tip.vbX, y1: tip.vbY, y2: yR[1], stroke, strokeDasharray: "3 3", strokeWidth: 0.75, style: { transition: t } }),
    mode === "both" && /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: xR[0], x2: tip.vbX, y1: tip.vbY, y2: tip.vbY, stroke, strokeDasharray: "3 3", strokeWidth: 0.75, style: { transition: t } }),
    /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("circle", { cx: tip.vbX, cy: tip.vbY, r: 3, fill: stroke, opacity: 0.8, style: { transition: t } })
  ] });
}
function TooltipOverlay({ tip, yLabel, currencyCfg, ms = 0 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(
    BaseBox,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(BaseText, { color: "muted", style: { fontSize: 9, textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 700, marginBottom: 2 }, children: tip.label }),
        tip.values.map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BaseText, { style: { color: v.color, fontSize: 12, fontWeight: 600 }, children: [
          v.name !== "value" ? `${v.name}: ` : "",
...
function ScatterSvg({ chart, width = 320, height = 150 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, style: { display: "block" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GridLines, { domain: yDom, range: yR, xRange: xR }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(XAxisLinear, { domain: xDom, y: height - MARGIN.bottom, range: xR }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(YAxis, { domain: yDom, range: yR, x: MARGIN.left }),
    data.map((d, i) => {
      const r = chart.type === "bubble" ? 4 + (d.z ?? 1) / maxZ * 16 : 4;
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("circle", { cx: xS(d.x), cy: yS(d.y), r, fill: "var(--primary)", opacity: 0.6 }, i);
    })
  ] });
}
function WaterfallSvg({ chart, width = 320, height = 150 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime6.jsxs)("svg", { viewBox: `0 0 ${width} ${height}`, width: "100%", height, style: { display: "block" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(GridLines, { domain: yDom, range: yR, xRange: xR }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(XAxisBand, { labels, y: yR[0], range: xR }),
    /* @__PURE__ */ (0, import_jsx_runtime6.jsx)(YAxis, { domain: yDom, range: yR, x: MARGIN.left }),
    bars.map((b, i) => {
      const bn = band_(b.label);
      return /* @__PURE__ */ (0, import_jsx_runtime6.jsx)("rect", { x: bn.x, y: yS(b.base + b.h), width: bn.width, height: Math.max(0, yS(b.base) - yS(b.base + b.h)), rx: 3, fill: b.color, opacity: 0.85 }, i);
    })
  ] });
}
...
function RangeBadge({ range, scaleX, yLabel, currencyCfg }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(
    BaseBox,
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(BaseText, { variant: "detail", style: { fontSize: 9, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", fontWeight: 700 }, children: [
          s.label,
          " \u2192 ",
          e.label
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime7.jsxs)(BaseText, { style: { color, fontSize: 13, fontWeight: 700 }, children: [
          delta < 0 ? "-" : "+",
...
function renderSeries(t, data, labels, band, yS, baseline, c2, series, pw, chart) {
  ...
  if (t === "distribution") {
    const bars = data.map((d, i) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: b.x, y: yS(d.value ?? 0), width: b.width, height: Math.max(0, h), rx: 3, fill: c2.primary, opacity: 0.5 }, i);
    });
    const g = chart?.gaussian;
    if (!g) return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: bars });
    ...
    const gauss = (x2) => 1 / (g.stddev * Math.sqrt(2 * Math.PI)) * Math.exp(-0.5 * ((x2 - g.mean) / g.stddev) ** 2) * scale;
    const x0 = band(labels[0]).x;
    const pts = Array.from({ length: 41 }, (_, i) => {
      const x2 = xMin + i / 40 * (xMax - xMin);
      return { x: x0 + i / 40 * pw, y: yS(Math.min(gauss(x2), maxY * 1.1)) };
    });
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      bars,
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: linePath(pts), fill: "none", stroke: c2.primary, strokeWidth: 2, opacity: 0.9 })
    ] });
  }
  if (isBar) return data.map((d, i) => {
    const b = band(labels[i]);
    const h = baseline - yS(d.value ?? 0);
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: b.x, y: yS(d.value ?? 0), width: b.width, height: Math.max(0, h), rx: 3, fill: c2.gradient ? "url(#gr-bar)" : c2.primary, opacity: 0.85 }, i);
  });
  if (isArea) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: areaPath(pts, baseline), fill: c2.fill, opacity: 0.12 }),
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: linePath(pts), fill: "none", stroke: c2.primary, strokeWidth: 2 })
    ] });
  }
  if (t === "line") {
    const pts = data.map((d, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)(import_jsx_runtime8.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: linePath(pts), fill: "none", stroke: c2.primary, strokeWidth: 2 }),
      pts.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("circle", { cx: p.x, cy: p.y, r: 2.5, fill: c2.primary }, i))
    ] });
  }
  if (t === "multi-line") return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: series.map((s, si) => {
    const pts = data.map((d, i) => {
      const b = band(labels[i]);
      return { x: b.x + b.width / 2, y: yS(d[s] || 0) };
    });
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: linePath(pts), fill: "none", stroke: seriesColor(c2, si), strokeWidth: 1.5 }),
      pts.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("circle", { cx: p.x, cy: p.y, r: 2, fill: seriesColor(c2, si) }, i))
    ] }, s);
  }) });
  if (t === "stacked-bar") return data.map((d, i) => {
    const b = band(labels[i]);
    let y0 = baseline;
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("g", { children: series.map((s, si) => {
      const v = d[s] || 0;
      const h = baseline - yS(v);
      const y2 = y0 - h;
      y0 = y2;
      const r = si === series.length - 1 ? 3 : 0;
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: b.x, y: y2, width: b.width, height: Math.max(0, h), rx: r, fill: seriesColor(c2, si), opacity: 0.85 }, s);
    }) }, i);
  });
  if (t === "stacked-area") {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(import_jsx_runtime8.Fragment, { children: series.map((s, si) => {
      const pts = data.map((d, i) => {
        const b = band(labels[i]);
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsxs)("g", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: `M${topD} ${baseD} Z`, fill: seriesColor(c2, si), opacity: 0.2 }),
        /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("path", { d: linePath(pts), fill: "none", stroke: seriesColor(c2, si), strokeWidth: 1.5 })
      ] }, s);
    }) });
  }
...
function CartesianRender({ chart, width = 320, height = 150 }) {
  ...
  const m2 = spark ? { top: 4, right: 4, bottom: 4, left: 4 } : MARGIN;
  const pw = width - m2.left - m2.right;
  const ph = h - m2.top - m2.bottom;
  const xR = [m2.left, m2.left + pw];
  const yR = [m2.top, m2.top + ph];
  if (t === "scatter" || t === "bubble") return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ScatterSvg, { chart, width, height });
  if (t === "waterfall") return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(WaterfallSvg, { chart, width, height });
  ...
  const onMove = (e) => {
    ...
    const vals = isStacked || isMulti ? series.map((s, i) => ({ name: s, value: data[r.idx][s] || 0, color: seriesColor(c2, i) })) : [{ name: "value", value: r.value, color: c2.primary }];
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("div", { style: { position: "relative", width: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)(
      "svg",
      {
        ...
        children: [
          c2.gradient && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime9.jsxs)("linearGradient", { id: "gr-bar", x1: "0", y1: "0", x2: "0", y2: "1", children: [
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("stop", { offset: "0%", stopColor: c2.gradient[0] }),
            /* @__PURE__ */ (0, import_jsx_runtime9.jsx)("stop", { offset: "100%", stopColor: c2.gradient[1] })
          ] }) }),
          ix.dragRange && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(RangeHighlight, { range, yR }),
          !spark && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(GridLines, { domain: yDom, range: [yR[1], yR[0]], xRange: xR }),
          !spark && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(XAxisBand, { labels, y: yR[1], range: xR }),
          !spark && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(YAxis, { domain: yDom, range: [yR[1], yR[0]], x: m2.left }),
          renderSeries(t, data, labels, band, yS, yR[1], c2, series, pw, chart),
          !spark && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(ThresholdLines, { thresholds: chart.thresholds, yScale: yS, xRange: xR }),
          !spark && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(Crosshairs, { tip, xR, yR, mode: ix.crosshair, ms: ix.transitionMs })
        ]
      }
    ),
    /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(TooltipOverlay, { tip, yLabel: chart.yLabel, currencyCfg: chart.currencyConfig, svgRef: ref, ms: ix.transitionMs }),
    ix.dragRange && /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(RangeBadge, { range, svgRef: ref, scaleX: scX, yLabel: chart.yLabel, currencyCfg: chart.currencyConfig })
  ] });
}
...
function RadialRender({ chart, size = 150 }) {
  const t = chart.type;
  if (t === "gauge") return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(GaugeSvg, { chart, size });
  if (t === "progress-ring") return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(RingSvg, { chart, size });
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(PieSvg, { chart, size, donut: t === "donut" });
}
function PieSvg({ chart, size, donut }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { position: "relative", width: "100%" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { ref, viewBox: `0 0 ${size} ${size}`, width: "100%", height: size, style: { display: "block" }, onMouseLeave: hide, children: [
      arcs.map((arc, i) => {
      ...
      donut && chart.yLabel && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("text", { x: cx, y: cy, textAnchor: "middle", dominantBaseline: "central", fontSize: 14, fontWeight: 700, fill: "var(--text-main)", children: chart.yLabel })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(TooltipOverlay, { tip, yLabel: chart.yLabel, currencyCfg: chart.currencyConfig, svgRef: ref })
  ] });
}
function GaugeSvg({ chart, size }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { textAlign: "center" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { viewBox: `0 0 ${size} ${size * 0.6}`, width: "100%", height: size * 0.55, style: { display: "block" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: bgPath, fill: "none", stroke: "var(--border-main)", strokeWidth: 8, strokeLinecap: "round", opacity: 0.15 }),
      /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("path", { d: fgPath, fill: "none", stroke: c2.primary, strokeWidth: 8, strokeLinecap: "round" })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)(BaseText, { weight: "bold", style: { fontSize: 18, marginTop: -4, color: c2.primary }, children: [
      chart.currencyConfig ? fmtValue(value, chart.currencyConfig) : value,
      chart.yLabel === "%" ? "%" : ""
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(BaseText, { variant: "detail", color: "muted", style: { fontSize: 9 }, children: d.label || chart.title })
  ] });
}
function RingSvg({ chart, size }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { textAlign: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("svg", { viewBox: `0 0 ${size} ${size}`, width: "100%", height: size, style: { display: "block" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("circle", { cx, cy, r, fill: "none", stroke: "var(--border-main)", strokeWidth: sw, opacity: 0.15 }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("text", { x: cx, y: cy - 4, textAnchor: "middle", fontSize: 22, fontWeight: 700, fill: "var(--text-main)", children: chart.currencyConfig ? fmtValue(value, chart.currencyConfig) : value }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("text", { x: cx, y: cy + 14, textAnchor: "middle", fontSize: 9, fill: "var(--text-muted)", children: d.label || chart.title })
  ] }) });
}
...
function FilteredPaperList({ papers }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { marginTop: 12 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("button", { onClick: () => setExpanded(!expanded), style: btnStyle, children: expanded ? "Hide papers" : `Show ${papers.length} paper${papers.length !== 1 ? "s" : ""}` }),
    expanded && /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("div", { style: { marginTop: 8, border: "1px solid #eee", borderRadius: 6, overflow: "auto", maxHeight: 500 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("table", { style: { width: "100%", borderCollapse: "collapse" }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("thead", { children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("tr", { style: { background: "#fafafa", textAlign: "left" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("th", { style: { ...cellStyle, fontWeight: 700, width: "40%" }, children: "Title" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("th", { style: { ...cellStyle, fontWeight: 700, width: "25%" }, children: "Authors" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("th", { style: { ...cellStyle, fontWeight: 700, width: "10%" }, children: "Year" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("th", { style: { ...cellStyle, fontWeight: 700, width: "15%" }, children: "Journal" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("th", { style: { ...cellStyle, fontWeight: 700, width: "10%", textAlign: "right" }, children: "Cited" })
        ] }) }),
        /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("tbody", { children: visible.map((r) => /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("tr", { style: { cursor: "default" }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("td", { style: { ...cellStyle, whiteSpace: "normal", maxWidth: 300 }, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
            "a",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("td", { style: cellStyle, title: r.authors?.join(", "), children: formatAuthors(r.authors) }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("td", { style: cellStyle, children: r.published ? r.published.substring(0, 4) : "\u2014" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("td", { style: cellStyle, title: r.journal, children: r.journal ? r.journal.substring(0, 25) : "\u2014" }),
          /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("td", { style: { ...cellStyle, textAlign: "right" }, children: r.citation_count ?? "\u2014" })
        ] }, r.doi)) })
      ] }),
      hasMore && !showAll && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)("div", { style: { padding: 8, textAlign: "center" }, children: /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)("button", { onClick: () => setShowAll(true), style: { ...btnStyle, border: "none", color: "#2563eb" }, children: [
        "Show all ",
        sorted.length,
        " papers"
      ] }) })
...
function ChartCard({ chart }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { background: "#fff", border: "1px solid #eee", borderRadius: 8, padding: "8px 10px 4px", overflow: "hidden" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: "#888", marginBottom: 4 }, children: chart.title }),
    isDonut ? /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(RadialRender, { chart, size: 200 }) : /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(CartesianRender, { chart, width: 340, height: 160 })
  ] });
}
function StatsBar({ nodes, edges, doiCount }) {
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { style: { display: "flex", gap: 16, fontSize: 12, color: "#666", fontFamily: "monospace", padding: "8px 0", flexWrap: "wrap" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { style: { color: "#333" }, children: [
      doiCount,
      " papers"
    ] }),
    TAG_CATEGORIES.map((cat) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("span", { style: { color: COLORS[cat] }, children: [
        count,
        " ",
        cat,
        count !== 1 ? "s" : ""
...
function buildCharts(filtered) {
  const charts = [];
  const withCitations = filtered.filter((r) => r.citation_count > 0).sort((a2, b) => b.citation_count - a2.citation_count).slice(0, 15);
  ...
  if (typeMap.size > 0) {
    const typeScheme = { sentiment: "neutral", primary: COLORS.type, fill: COLORS.type, seriesColors: Object.values(COLORS) };
  ...
  const journalMap = /* @__PURE__ */ new Map();
  for (const r of filtered) if (r.journal) journalMap.set(r.journal, (journalMap.get(r.journal) || 0) + 1);
  if (journalMap.size > 0) {
    charts.push({ type: "bar", title: "By Journal", yLabel: "Count", colorScheme: scheme(COLORS.journal), data: [...journalMap.entries()].sort((a2, b) => b[1] - a2[1]).slice(0, 12).map(([label, value]) => ({ label: label.substring(0, 22), value })) });
  }
  const yearMap = /* @__PURE__ */ new Map();
  for (const r of filtered) {
    if (r.published) {
      const y2 = r.published.substring(0, 4);
      if (/^\d{4}$/.test(y2)) yearMap.set(y2, (yearMap.get(y2) || 0) + 1);
    }
  }
  if (yearMap.size > 0) {
    charts.push({ type: yearMap.size > 1 ? "line" : "bar", title: "Timeline", yLabel: "Papers", colorScheme: scheme(COLORS.year), data: [...yearMap.entries()].sort((a2, b) => a2[0].localeCompare(b[0])).map(([label, value]) => ({ label, value })) });
  }
  const authorMap = /* @__PURE__ */ new Map();
  for (const r of filtered) if (r.authors) for (const a2 of r.authors) authorMap.set(a2, (authorMap.get(a2) || 0) + 1);
  const topAuthors = [...authorMap.entries()].sort((a2, b) => b[1] - a2[1]).slice(0, 15);
  ...
  for (const r of filtered) if (r.publisher) pubMap.set(r.publisher, (pubMap.get(r.publisher) || 0) + 1);
  if (pubMap.size > 0) {
    charts.push({ type: "bar", title: "Publishers", yLabel: "Count", colorScheme: scheme(COLORS.publisher), data: [...pubMap.entries()].sort((a2, b) => b[1] - a2[1]).slice(0, 10).map(([label, value]) => ({ label: label.substring(0, 22), value })) });
  }
  return charts;
}
function FilteredCharts({ matchingDois, totalDois }) {
  ...
  if (!loaded) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { padding: 12, color: "#999", fontFamily: "monospace", fontSize: 12 }, children: "Loading charts..." });
  if (!filtered.length) return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { padding: 12, color: "#999", fontFamily: "monospace", fontSize: 12 }, children: "No matching papers for current selection." });
  const charts = buildCharts(filtered);
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("div", { children: [
    charts.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)(import_jsx_runtime12.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { fontSize: 11, color: "#666", fontFamily: "monospace", marginBottom: 8 }, children: isFiltered ? `Charts for ${filtered.length} of ${totalDois} papers (filtered)` : `Charts for all ${filtered.length} papers` }),
      /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 8 }, children: charts.map((chart, i) => /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ChartCard, { chart }, `${chart.title}-${filtered.length}-${i}`)) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(FilteredPaperList, { papers: filtered })
  ] });
}

// public/graph-canvas.tsx
var import_react13 = __toESM(require_react());

// public/node-shapes.ts
function shapePath(group, cx, cy, r) {
  switch (group) {
    case "institution": {
    ...
    case "author": {
      const pts = [];
      for (let i = 0; i < 6; i++) {
        const a2 = Math.PI / 3 * i - Math.PI / 2;
...
function NodeGlyph({
  ...
  const label = isDoi ? hovered || selected ? node.label : node.label.length > 22 ? node.label.substring(0, 20) + "\u2026" : node.label : node.label.length > 28 ? node.label.substring(0, 25) + "..." : node.label;
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsxs)(
    "g",
    {
      ...
      children: [
        (selected || highlighted || hovered) && (d ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d: shapePath(node.group, node.x, node.y, r + 5), fill: "none", stroke: cColor, strokeWidth: hovered ? 2 : 1.5, opacity: 0.5 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: node.x, cy: node.y, r: r + 5, fill: "none", stroke: cColor, strokeWidth: hovered ? 2 : 1.5, opacity: 0.5 })),
        d ? /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("path", { d, fill: selected ? cColor : cBg, stroke: cColor, strokeWidth: r >= 8 ? 2 : 1.5 }) : /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("circle", { cx: node.x, cy: node.y, r, fill: selected ? cColor : cBg, stroke: cColor, strokeWidth: r >= 8 ? 2 : 1.5 }),
        !dimmed && isDoi && (hovered || selected) && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("text", { x: node.x + r + 4, y: node.y - 4, fontSize, fontFamily: "monospace", fill: "#333", children: wrapLabel(label, 30).map((line, i) => /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("tspan", { x: node.x + r + 4, dy: i === 0 ? 0 : 11, children: line }, i)) }),
        !dimmed && isDoi && !hovered && !selected && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)("text", { x: node.x + r + 4, y: node.y + 3.5, fontSize, fontFamily: "monospace", fill: "#333", opacity: 0.5, children: label }),
        !dimmed && !isDoi && /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(
          "text",
          {
            x: node.x + r + 4,
            y: node.y + 3.5,
            fontSize,
            fontFamily: "monospace",
            fontWeight: selected || node.role === "hub" ? 700 : 400,
...
function EdgeDefs({ edges, nodeMap }) {
  ...
  for (const e of edges) {
    ...
    gradients.push(
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("linearGradient", { id: `eg-${key}`, gradientUnits: "userSpaceOnUse", children: [
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("stop", { offset: "0%", stopColor: COLORS[g1] }),
        /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("stop", { offset: "100%", stopColor: COLORS[g2] })
      ] }, key)
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("defs", { children: gradients });
}
function EdgeLine({ edge, nodeMap, selectedNodeId, connectedIds, hovered, onMouseEnter, onMouseLeave }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("g", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      "line",
      {
        ...
        onMouseEnter,
        onMouseLeave,
        children: /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("animate", { attributeName: "stroke-dashoffset", from: "1", to: "0", dur: "0.4s", fill: "freeze" })
      }
    ),
    showWeight && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(
      "text",
      {
        x: mx,
        y: my - 4,
...
// public/node-card.tsx
var import_jsx_runtime15 = __toESM(require_jsx_runtime());
function NodeCard({ node, cColor, selected, hovered, expanded, dimmed, isJournal, handlers, style, onSelectPaper }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { ...handlers, style: {
    ...style,
    width: cw,
    ...
    borderRadius: 8,
    padding: "6px 0",
    boxShadow: open ? "0 8px 24px rgba(0,0,0,0.12), inset 0 1px 0 rgba(255,255,255,0.6)" : "0 2px 8px rgba(0,0,0,0.06), inset 0 1px 0 rgba(255,255,255,0.5)",
    opacity: dimmed ? 0.1 : 1,
    transition: "opacity 200ms, box-shadow 300ms",
    fontFamily: "monospace"
  }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { textAlign: "center", fontSize: 12, fontWeight: 700, color: "#222", lineHeight: "16px", padding: "0 8px" }, children: trunc }),
    isJournal && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: {
      textAlign: "center",
      fontSize: 10,
      color: cColor,
      marginTop: 2,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { padding: "6px 12px 4px", borderTop: "1px solid rgba(0,0,0,0.06)", marginTop: 6 }, children: [
        node.ext_id && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { fontSize: 11, color: "#777", marginBottom: 5 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { textTransform: "uppercase", fontSize: 9, letterSpacing: 0.5, color: cColor, fontWeight: 700 }, children: node.group === "journal" ? "ISSN-L" : node.group === "author" ? "ORCID" : "ROR" }),
          " ",
          /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { color: "#333" }, children: node.ext_id })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { display: "flex", gap: 12, fontSize: 11, marginBottom: 5 }, children: [
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("strong", { style: { color: cColor, fontSize: 13 }, children: node.doiCount }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { color: "#888" }, children: "papers" })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("span", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("strong", { style: { color: cColor, fontSize: 13 }, children: node.degree }),
            " ",
            /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("span", { style: { color: "#888" }, children: "links" })
          ] })
        ] }),
        node.topKeywords && node.topKeywords.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { fontSize: 11, color: "#666", fontStyle: "italic" }, children: node.topKeywords.join(" \xB7 ") })
      ] }),
      visiblePapers.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { borderTop: "1px solid rgba(0,0,0,0.06)", padding: "6px 0 2px", marginTop: 2 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime15.jsx)("div", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: cColor, fontWeight: 700, padding: "0 12px 4px" }, children: "Papers" }),
        visiblePapers.map((p, i) => /* @__PURE__ */ (0, import_jsx_runtime15.jsx)(
          "div",
          {
            onClick: (e) => {
              e.stopPropagation();
        ...
        papers.length > 6 && /* @__PURE__ */ (0, import_jsx_runtime15.jsxs)("div", { style: { fontSize: 11, color: cColor, padding: "4px 12px", fontWeight: 600 }, children: [
          "+",
          papers.length - 6,
          " more"
        ] })
...
// public/paper-card.tsx
var import_react12 = __toESM(require_react());
var import_jsx_runtime16 = __toESM(require_jsx_runtime());
function PaperCard({ doi, onClose, style }) {
  const [record, setRecord] = (0, import_react12.useState)(null);
  const [loading, setLoading] = (0, import_react12.useState)(true);
  (0, import_react12.useEffect)(() => {
    fetch(`/api/records/${encodeURIComponent(doi)}`).then((r) => r.json()).then((d) => {
      if (d && !d.error) setRecord(d);
      setLoading(false);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { fontSize: 13, fontWeight: 700, color: "#222", lineHeight: "18px", flex: 1, wordBreak: "break-word" }, children: record?.title || doi }),
    ...
    loading && /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { fontSize: 11, color: "#999" }, children: "Loading..." }),
    record && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { fontSize: 11, color: "#555" }, children: [
      record.authors && record.authors.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { marginBottom: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: "#c62828", fontWeight: 700 }, children: "Authors" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { color: "#444", marginTop: 2 }, children: [
          record.authors.slice(0, 5).join(", "),
          record.authors.length > 5 ? ` +${record.authors.length - 5}` : ""
        ] })
      ] }),
      record.journal && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { marginBottom: 6 }, children: [
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: "#2e7d32", fontWeight: 700 }, children: "Journal" }),
        /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { color: "#444", marginTop: 2 }, children: record.journal })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { style: { display: "flex", gap: 14, marginBottom: 6, flexWrap: "wrap" }, children: [
        record.published && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: "#888", fontWeight: 700 }, children: "Year " }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("strong", { style: { color: "#333" }, children: record.published.substring(0, 4) })
        ] }),
        record.citation_count > 0 && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: "#888", fontWeight: 700 }, children: "Citations " }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("strong", { style: { color: "#333" }, children: record.citation_count })
        ] }),
        record.type && /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("span", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { fontSize: 9, textTransform: "uppercase", letterSpacing: 0.5, color: "#888", fontWeight: 700 }, children: "Type " }),
          /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("span", { style: { color: "#333" }, children: record.type })
        ] })
      ] })
    ] }),
...
var CARD_GROUPS = /* @__PURE__ */ new Set(["institution", "author", "journal"]);
function GraphCanvas({
  ...
  const [hoveredEdgeIdx, setHoveredEdgeIdx] = (0, import_react13.useState)(null);
  const [mousePos, setMousePos] = (0, import_react13.useState)({ x: 0, y: 0 });
  const [selectedPaper, setSelectedPaper] = (0, import_react13.useState)(null);
  const onNodeDragStart = (0, import_react13.useCallback)((nodeId, clientX, clientY, svgEl) => {
  ...
  const onNodeDrag = (0, import_react13.useCallback)((clientX, clientY, svgEl) => {
  ...
  const onNodeDragEnd = (0, import_react13.useCallback)(() => {
    const drag = dragRef.current;
    if (!drag) return;
    drag.node.fx = null;
    drag.node.fy = null;
  ...
  const catIndexMap = (0, import_react13.useMemo)(() => new Map(categoryOrder.map((cat, i) => [cat, i])), [categoryOrder]);
  const hoveredEdge = hoveredEdgeIdx !== null ? projectedEdges[hoveredEdgeIdx] : null;
  const dense = layoutNodes.length > 80;
  const pad = 60;
  const inView = (x2, y2) => x2 >= -pad && x2 <= dims.width + pad && y2 >= -pad && y2 <= dims.height + pad;
  const visibleNodes = (0, import_react13.useMemo)(() => layoutNodes.filter((n) => inView(n.x, n.y)), [layoutNodes, dims.width, dims.height]);
  const visibleEdges = (0, import_react13.useMemo)(() => projectedEdges.filter((e) => {
    const s = nodeMap.get(e.source), t = nodeMap.get(e.target);
    return s && t && (inView(s.x, s.y) || inView(t.x, t.y));
  }), [projectedEdges, nodeMap, dims.width, dims.height]);
  const cardNodes = (0, import_react13.useMemo)(() => visibleNodes.filter((n) => CARD_GROUPS.has(n.group)), [visibleNodes]);
  const nonCardNodes = (0, import_react13.useMemo)(() => visibleNodes.filter((n) => !CARD_GROUPS.has(n.group)), [visibleNodes]);
  return /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)("div", { style: { position: "relative" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("style", { children: `@keyframes card-in { from { opacity: 0; transform: translate(-50%,-50%) scale(0.85); } to { opacity: 1; transform: translate(-50%,-50%) scale(1); } }
@keyframes card-expand { from { opacity: 0; transform: translateY(-8px); } to { opacity: 1; transform: translateY(0); } }` }),
    /* @__PURE__ */ (0, import_jsx_runtime17.jsxs)(
      "svg",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(EdgeDefs, { edges: visibleEdges, nodeMap }),
          visibleEdges.map((e, i) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
            EdgeLine,
            {
              edge: e,
              nodeMap,
          ...
          nonCardNodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
            NodeGlyph,
            {
              node: n,
              ...
              onDragStart: (e) => {
                ...
                if (svg) onNodeDragStart(n.id, e.clientX, e.clientY, svg);
              },
    ...
    hoveredNodeId && CARD_GROUPS.has(nodeMap.get(hoveredNodeId)?.group || "") && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)("div", { style: {
      position: "absolute",
      inset: 0,
    ...
    cardNodes.map((n) => /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      NodeCard,
      {
        node: n,
        cColor: COLORS[n.group] || "#666",
        selected: n.id === selectedNodeId,
        hovered: hoveredNodeId === n.id,
    ...
    selectedPaper && /* @__PURE__ */ (0, import_jsx_runtime17.jsx)(
      PaperCard,
      {
        ...
        open && matches.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("div", { style: {
          ...
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime18.jsx)("span", { style: { color: "#999", fontSize: 10, marginLeft: "auto" }, children: n.group })
            ]
          },
          n.id
        )) })
...
function GraphLegend() {
  return /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("div", { style: {
    display: "inline-flex",
    gap: 12,
    fontSize: 11,
    fontFamily: "monospace",
    ...
    ITEMS.map(({ group, shape, label }) => /* @__PURE__ */ (0, import_jsx_runtime19.jsxs)("span", { style: { display: "inline-flex", alignItems: "center", gap: 3 }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { color: COLORS[group], fontSize: 13 }, children: shape }),
      /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { children: label })
    ] }, group)),
    /* @__PURE__ */ (0, import_jsx_runtime19.jsx)("span", { style: { color: "#999", fontSize: 10 }, children: "size = paper count" })
  ] });
}
...
function yearOf(n) {
  ...
  const y2 = parseInt(n.published.substring(0, 4));
  return y2 > 1900 ? y2 : 0;
}
...
function TimeSlider({ min, max, value, onChange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime20.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 8, fontFamily: "monospace", fontSize: 11, minWidth: 200 }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { color: "#999" }, children: min }),
    ...
    /* @__PURE__ */ (0, import_jsx_runtime20.jsx)("span", { style: { color: "#333", fontWeight: 700, minWidth: 32 }, children: display })
  ] });
}
...
function RelationshipExplorer() {
  ...
  const [expandedJournal, setExpandedJournal] = (0, import_react17.useState)(null);
  const [maxYear, setMaxYear] = (0, import_react17.useState)((/* @__PURE__ */ new Date()).getFullYear());
  const containerRef = (0, import_react17.useRef)(null);
  const [dims, setDims] = (0, import_react17.useState)({ width: 1100, height: 600 });
  const {
    categoryOrder,
    activeCategories,
    pinnedTags,
  ...
  const extraRows = expandedJournal ? 3 : 0;
  const jCount = rawNodes.filter((n) => n.group === "journal").length;
  const gridRows = Math.ceil(jCount / 4);
  const baseHeight = Math.max(500, 120 + (gridRows + extraRows) * 80);
  (0, import_react17.useEffect)(() => {
  ...
  const handleSelect = (0, import_react17.useCallback)((id) => {
    if (id) {
  ...
  const { nodes: projectedNodesRaw, edges: projectedEdges, matchingDois } = (0, import_react17.useMemo)(
  ...
  const totalCounts = (0, import_react17.useMemo)(() => {
    const c2 = /* @__PURE__ */ new Map();
    for (const e of rawEdges) c2.set(e.target, (c2.get(e.target) || 0) + 1);
    return c2;
  }, [rawEdges]);
  const projectedNodes = (0, import_react17.useMemo)(() => enrichWithMeta(projectedNodesRaw, tagMeta).map((n) => ({
    ...n,
  ...
  const nodeMap = (0, import_react17.useMemo)(() => new Map(layoutNodes.map((n) => [n.id, n])), [layoutNodes]);
  ...
  const chartDois = (0, import_react17.useMemo)(() => {
    ...
    for (const e of rawEdges) if (e.target === selectedNodeId) {
      const doi = e.source.replace("doi:", "");
      if (matchingDois.has(doi)) nodeDois.add(doi);
    }
    return nodeDois;
  }, [selectedNodeId, rawEdges, matchingDois]);
  const { categoryCounts, tagsByCategory } = useTagCounts(rawNodes, rawEdges);
  const pinnedSet = (0, import_react17.useMemo)(() => new Set(pinnedTags), [pinnedTags]);
  if (loading) return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { padding: 24, fontFamily: "monospace", color: "#999" }, children: "Loading graph data..." });
  if (!rawNodes.length) return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { padding: 24, fontFamily: "monospace", color: "#999" }, children: "No data." });
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { ref: containerRef, children: [
    /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { style: { marginBottom: 12, display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("button", { onClick: () => setFiltersVisible(!filtersVisible), style: { background: "none", border: "1px solid #ddd", borderRadius: 4, cursor: "pointer", fontSize: 12, color: "#555", fontFamily: "monospace", padding: "4px 10px" }, children: [
        filtersVisible ? "Hide Filters" : "Filters",
        pinnedTags.length > 0 ? ` (${pinnedTags.length})` : ""
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(GraphSearch, { nodes: projectedNodes, onSelect: handleSelect }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(GraphLegend, {}),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(TimeSlider, { min: yearMin, max: yearMax, value: maxYear, onChange: setMaxYear })
    ] }),
    filtersVisible && /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(CategoryStrip, { categories: categoryOrder, counts: categoryCounts, active: activeCategories, onToggle: toggleCategory, onReorder: reorderCategories }),
      /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { background: "#fafafa", border: "1px solid #eee", borderRadius: 6, padding: "8px 12px", marginBottom: 12 }, children: categoryOrder.map((cat) => {
        if (!activeCategories.has(cat)) return null;
        const tags = tagsByCategory[cat];
        if (!tags?.length) return null;
        return /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(TagPicker, { category: cat, tags, pinnedTags: pinnedSet, pinnedOrder: pinnedTags, onToggleTag: toggleTag }, cat);
      }) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)("div", { style: { position: "relative" }, children: [
      projectedNodes.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { padding: 40, textAlign: "center", color: "#999", fontFamily: "monospace" }, children: "No data." }) : /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(GraphCanvas, { dims, projectedEdges, layoutNodes, nodeMap, selectedNodeId, connectedIds, simMutableRef, d3SimRef, onSelect: handleSelect, categoryOrder: categoryOrder.filter((c2) => activeCategories.has(c2)), expandedJournal }),
      selectedNode && /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(DetailPanel, { node: selectedNode, connections: selectedConnections, edgesForNode, onClose: () => setSelectedNodeId(null), onSelectNode: (id) => setSelectedNodeId(id) })
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(StatsBar, { nodes: projectedNodes, edges: projectedEdges, doiCount }),
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("div", { style: { marginTop: 16, borderTop: "1px solid #eee", paddingTop: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)(FilteredCharts, { matchingDois: chartDois, totalDois: doiCount }) })
  ] });
}
var root = (0, import_client.createRoot)(document.getElementById("relationships-root"));
root.render(/* @__PURE__ */ (0, import_jsx_runtime21.jsx)(RelationshipExplorer, {}));
