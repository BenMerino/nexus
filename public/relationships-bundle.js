...
var TAG_CATEGORIES = ["author", "journal", "publisher", "type", "institution", "venue", "year"];
var COLORS = {
  author: "#c62828",
  journal: "#2e7d32",
  publisher: "#1565c0",
...
function projectGraph(rawNodes, rawEdges, activeCategories, pinnedTags) {
  ...
  const pinnedByCategory = /* @__PURE__ */ new Map();
  for (const id of pinnedSet) {
    const node = rawNodes.find((n) => n.id === id);
    if (node) {
      let set2 = pinnedByCategory.get(node.group);
      if (!set2) {
        set2 = /* @__PURE__ */ new Set();
        pinnedByCategory.set(node.group, set2);
      }
      set2.add(id);
    }
  }
  ...
  for (const [doiId, tags] of doiToTags) {
    ...
    for (let i = 0; i < visible.length; i++) {
      for (let j = i + 1; j < visible.length; j++) {
        ...
        if (!entry) {
          entry = { source: visible[i], target: visible[j], dois: /* @__PURE__ */ new Set() };
...
function CategoryStrip({ categories, counts, active, onToggle, onReorder }) {
  const [dragIdx, setDragIdx] = (0, import_react2.useState)(null);
  const [overIdx, setOverIdx] = (0, import_react2.useState)(null);
  const dragRef = (0, import_react2.useRef)(null);
  const onDragStart = (0, import_react2.useCallback)((e, idx) => {
    dragRef.current = idx;
    setDragIdx(idx);
    e.dataTransfer.effectAllowed = "move";
  }, []);
  const onDragOver = (0, import_react2.useCallback)((e, idx) => {
    e.preventDefault();
    e.dataTransfer.dropEffect = "move";
    setOverIdx(idx);
  }, []);
  const onDrop = (0, import_react2.useCallback)((e, toIdx) => {
    e.preventDefault();
...
function DetailPanel({
  ...
  const allDois = (0, import_react3.useMemo)(() => {
...
var BaseBox = import_react4.default.forwardRef(
...
function XAxisBand({ labels, y: y3, range }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: labels.map((l, i) => {
    ...
    return rotate ? /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: y3 + 6, textAnchor: "end", transform: `rotate(-40,${cx},${y3 + 6})`, ...TICK, children: display }, i) : /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: cx, y: y3 + 14, textAnchor: "middle", ...TICK, children: display }, i);
  }) });
}
function XAxisLinear({ domain, y: y3, range }) {
  const s = linearScale([domain.min, domain.max], range);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ticks(domain).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: s(v), y: y3 + 14, textAnchor: "middle", ...TICK, children: v }, i)) });
}
function YAxis({ domain, range, x: x3 }) {
  const s = linearScale([domain.min, domain.max], range);
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: ticks(domain).map((v, i) => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: x3 - 4, y: s(v) + 3, textAnchor: "end", ...TICK, children: fmtTick(v) }, i)) });
}
function fmtTick(v) {
...
function ThresholdLines({ thresholds, yScale, xRange }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(import_jsx_runtime5.Fragment, { children: thresholds.map((t, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)("g", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("line", { x1: xRange[0], x2: xRange[1], y1: y3, y2: y3, stroke: t.color, strokeDasharray: "4 4", strokeWidth: 1 }),
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)("text", { x: xRange[1] - 2, y: y3 - 4, textAnchor: "end", fontSize: 9, fontWeight: 600, fill: t.color, children: t.label })
    ] }, i);
  }) });
}
function useTooltip() {
  const [tip, setTip] = (0, import_react5.useState)(null);
  const show = (0, import_react5.useCallback)((state) => setTip(state), []);
  const hide = (0, import_react5.useCallback)(() => setTip(null), []);
...
function useDragRange() {
  const [range, setRange] = (0, import_react6.useState)(INIT);
  const startRef = (0, import_react6.useRef)(null);
  const onDown = (0, import_react6.useCallback)((ep) => {
    startRef.current = ep;
    setRange({ start: ep, end: ep, dragging: true });
  }, []);
  const onDrag = (0, import_react6.useCallback)((ep) => {
...
function renderSeries(t, data, labels, band, yS, baseline, c2, series, pw, chart) {
  ...
  if (t === "distribution") {
    ...
    const gauss = (x3) => 1 / (g.stddev * Math.sqrt(2 * Math.PI)) * Math.exp(-0.5 * ((x3 - g.mean) / g.stddev) ** 2) * scale;
  ...
  if (t === "stacked-bar") return data.map((d, i) => {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("g", { children: series.map((s, si) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)("rect", { x: b.x, y: y3, width: b.width, height: Math.max(0, h), rx: r, fill: seriesColor(c2, si), opacity: 0.85 }, s);
    }) }, i);
  });
  if (t === "stacked-area") {
...
function ChartCard({ chart }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { background: "#fff", border: "1px solid #eee", borderRadius: 8, padding: "8px 10px 4px", overflow: "hidden" }, children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: 0.5, color: "#888", marginBottom: 4 }, children: chart.title }),
    isDonut ? /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(RadialRender, { chart, size: 200 }) : /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(CartesianRender, { chart, width: 340, height: 160 })
  ] });
}
function StatsBar({ nodes, edges, doiCount }) {
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { display: "flex", gap: 16, fontSize: 12, color: "#666", fontFamily: "monospace", padding: "8px 0", flexWrap: "wrap" }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { style: { color: "#333" }, children: [
      doiCount,
      " papers"
    ] }),
    TAG_CATEGORIES.map((cat) => {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("span", { style: { color: COLORS[cat] }, children: [
        count,
        " ",
        cat,
        count !== 1 ? "s" : ""
...
function buildCharts(filtered) {
  ...
  for (const r of filtered) {
    if (r.published) {
      const y3 = r.published.substring(0, 4);
      if (/^\d{4}$/.test(y3)) yearMap.set(y3, (yearMap.get(y3) || 0) + 1);
    }
  }
  if (yearMap.size > 0) {
...
function FilteredCharts({ matchingDois, totalDois }) {
  ...
  if (!loaded) return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { padding: 12, color: "#999", fontFamily: "monospace", fontSize: 12 }, children: "Loading charts..." });
  if (!filtered.length) return /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { padding: 12, color: "#999", fontFamily: "monospace", fontSize: 12 }, children: "No matching papers for current selection." });
  const charts = buildCharts(filtered);
  if (!charts.length) return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { style: { padding: 12, color: "#999", fontFamily: "monospace", fontSize: 12 }, children: [
    filtered.length,
    " paper",
    filtered.length !== 1 ? "s" : "",
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("div", { children: [
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { fontSize: 11, color: "#666", fontFamily: "monospace", marginBottom: 8 }, children: isFiltered ? `Charts for ${filtered.length} of ${totalDois} papers (filtered)` : `Charts for all ${filtered.length} papers` }),
    /* @__PURE__ */ (0, import_jsx_runtime10.jsx)("div", { style: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(340px, 1fr))", gap: 8 }, children: charts.map((chart, i) => /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(ChartCard, { chart }, `${chart.title}-${filtered.length}-${i}`)) })
  ] });
}
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime11.jsxs)(
    "g",
    {
      ...
      children: [
        ...
        (selected || highlighted || hovered) && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "circle",
          {
            cx: node.x,
            cy: node.y,
        ...
        (node.weight || 0) > 1 && !dimmed && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "text",
          {
            x: node.x,
            y: node.y + 3.5,
        ...
        !dimmed && /* @__PURE__ */ (0, import_jsx_runtime11.jsx)(
          "text",
          {
            x: node.x + r + 4,
            y: node.y + 3.5,
...
function bezierControlPoint(x1, y1, x22, y22, offset) {
  const mx = (x1 + x22) / 2;
  const my = (y1 + y22) / 2;
  const dx = x22 - x1;
  const dy = y22 - y1;
...
function EdgeDefs({ edges, nodeMap }) {
  ...
  for (const e of edges) {
    ...
    gradients.push(
      /* @__PURE__ */ (0, import_jsx_runtime12.jsxs)("linearGradient", { id: `eg-${key}`, gradientUnits: "userSpaceOnUse", children: [
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("stop", { offset: "0%", stopColor: COLORS[g1] }),
        /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("stop", { offset: "100%", stopColor: COLORS[g2] })
      ] }, key)
    );
  }
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)("defs", { children: gradients });
}
...
function NodeHoverCard({ node, edges }) {
  const topConns = edges.map((e) => ({ id: e.source === node.id ? e.target : e.source, weight: e.weight })).sort((a2, b) => b.weight - a2.weight).slice(0, 3);
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: {
    background: "#fff",
    border: `1px solid ${COLORS[node.group]}`,
    borderRadius: 6,
    padding: "8px 12px",
    fontFamily: "monospace",
    fontSize: 11,
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }, children: [
    ...
    node.topKeywords && node.topKeywords.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { color: "#555", fontSize: 10, marginBottom: 4, fontStyle: "italic" }, children: node.topKeywords.join(", ") }),
    topConns.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { borderTop: "1px solid #eee", paddingTop: 4, fontSize: 10 }, children: topConns.map((c2) => /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { color: "#555" }, children: [
      c2.id.replace(/^[^:]+:/, ""),
      " ",
      /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("span", { style: { color: "#aaa" }, children: [
        "(",
        c2.weight,
        ")"
      ] })
...
function EdgeHoverCard({ edge, nodeMap }) {
  const s = nodeMap.get(edge.source);
  const t = nodeMap.get(edge.target);
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: {
    background: "#fff",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { fontWeight: 700, marginBottom: 4, fontSize: 11 }, children: [
      s?.label || edge.source,
      " \u2194 ",
      t?.label || edge.target
    ] }),
    ...
    edge.sharedDois.slice(0, 5).map((d, i) => /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("div", { style: { fontSize: 10, color: "#555", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", maxWidth: 260 }, children: d }, i)),
    edge.sharedDois.length > 5 && /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { style: { fontSize: 10, color: "#999" }, children: [
      "+",
...
function HoverCard({ hoveredNode, hoveredEdge, nodeMap, projectedEdges, dims }) {
  ...
  x3 = Math.min(x3, dims.width - 220);
  y3 = Math.max(10, Math.min(y3, dims.height - 120));
  const nodeEdges = hoveredNode ? projectedEdges.filter((e) => e.source === hoveredNode.id || e.target === hoveredNode.id) : [];
  return /* @__PURE__ */ (0, import_jsx_runtime14.jsx)("foreignObject", { x: x3, y: y3, width: 260, height: 200, style: { overflow: "visible", pointerEvents: "none" }, children: /* @__PURE__ */ (0, import_jsx_runtime14.jsxs)("div", { xmlns: "http://www.w3.org/1999/xhtml", children: [
    hoveredNode && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(NodeHoverCard, { node: hoveredNode, edges: nodeEdges }),
    hoveredEdge && !hoveredNode && /* @__PURE__ */ (0, import_jsx_runtime14.jsx)(EdgeHoverCard, { edge: hoveredEdge, nodeMap })
  ] }) });
}
...
function GraphCanvas({
  ...
  const [hoveredEdgeIdx, setHoveredEdgeIdx] = (0, import_react11.useState)(null);
  const onNodeDragStart = (0, import_react11.useCallback)((nodeId, clientX, clientY, svgEl) => {
  ...
  const onNodeDrag = (0, import_react11.useCallback)((clientX, clientY, svgEl) => {
  ...
  const onNodeDragEnd = (0, import_react11.useCallback)(() => {
    const drag = dragRef.current;
    if (!drag) return;
    drag.node.fx = null;
    drag.node.fy = null;
...
function RelationshipExplorer() {
  ...
  const toggleCategory = (0, import_react14.useCallback)((cat) => {
    setActiveCategories((prev) => {
      ...
      if (next.has(cat)) {
        ...
        setPinnedTags((p) => {
          const filtered = p.filter((id) => !id.startsWith(cat + ":"));
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsxs)("div", { ref: containerRef, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime16.jsx)("div", { style: { marginTop: 16, borderTop: "1px solid #eee", paddingTop: 16 }, children: /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(FilteredCharts, { matchingDois: chartDois, totalDois: doiCount }) })
  ] });
}
var root = (0, import_client.createRoot)(document.getElementById("relationships-root"));
root.render(/* @__PURE__ */ (0, import_jsx_runtime16.jsx)(RelationshipExplorer, {}));
