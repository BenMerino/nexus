...
function NodeDetail({ nodeId, onClose, onBack, empty, accentColor, navDir = "forward" }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: `node-detail-home${showingDetail ? " is-hidden" : ""}`, children: fallback }),
    showingDetail && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)("div", { className: `node-detail-swap ${dirClass}${accented && accentColor ? " detail-accented" : ""}`, style: accented ? style : void 0, children: content }, key)
  ] });
}
...
function useViewTransform({ override, zoomToId, zoomScale, nodes, adapter, width, height }) {
  ...
  const liveRef = (0, import_react3.useRef)({ zoomToId, zoomScale, nodes, adapter, width, height });
...
function ForceGraph({ nodes, links, width, height, selectedId, onNodeClick, affiliations, homeInstitutionId = null, egoAuthorId = null, expandedIds, onExpand, externalHoverId, onHoverChange }) {
  ...
  const journalByDoi = (0, import_react6.useMemo)(() => {
  ...
  const { placeholder } = (0, import_react6.useMemo)(
  ...
  const hullTier = (0, import_react6.useMemo)(() => hullTierFor(nodes), [nodes]);
  ...
  const forceConfig = (0, import_react6.useMemo)(() => {
