...
async function addMissingColumns() {
  ...
  await safe("ALTER TABLE users ADD COLUMN IF NOT EXISTS department TEXT");
  await safe("ALTER TABLE users ADD COLUMN IF NOT EXISTS profile_category TEXT");
  await safe("ALTER TABLE users ADD COLUMN IF NOT EXISTS tenant_admin BOOLEAN DEFAULT FALSE");
}
